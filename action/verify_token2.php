...
if (isset($_POST['submit'])) {
    ...
    // EXECUTE A SELECT QUERY TO RETIEVE ALL ROWS FROM THE TABLE REGISTERED_EMPLOYEE
    $sql = mysqli_query($conn, "SELECT * FROM registered_employee");
    ...
    if ($count == 1) {
        ...
        header("location: ../pages/employee_reset.php");
